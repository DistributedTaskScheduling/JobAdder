...
class ServerDatabase(ABC):
    ...
    def find_job_by_id(self, job_id: str) -> Job:
        ...
        @return The stored data about the job, or None if no such job was
          found.
        """
    ...
    def update_job(self, job: Job) -> None:
        ...
        If no job with the id of @job has been stored up to now, a new entry
    ...
    def update_work_machine(self, machine: WorkMachine) -> None:
        ...
        If there is no entry in the database for the given work machine, a new
        entry will be added.
    ...
    def get_current_schedule(self) -> JobDistribution:
        ...
        @return A list of all scheduleable and scheduled jobs, with their
