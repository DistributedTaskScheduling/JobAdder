...
class ServerConfig(Config):
    ...
    def __init__(self, admin_group: str, database_config: LoginConfig, email_config: LoginConfig,
                 ...
                 blocking_enabled: bool = True, preemption_enabled: bool = True, web_server_enabled: bool = True):
        ...
        self._web_server_enabled = web_server_enabled
    ...
    def __eq__(self, o: object) -> bool:
        if isinstance(o, ServerConfig):
            return self._admin_group == o.admin_group \
                ...
                and self._web_server_enabled == o.web_server_enabled
        else:
            return False
    ...
    def web_server_enabled(self) -> bool:
        ...
        """
        return self._web_server_enabled
    ...
    def to_dict(self) -> Dict[str, object]:
        ...
        d["web_server_enabled"] = self._web_server_enabled
        return d
    ...
    def from_dict(cls, property_dict: Dict[str, object]) -> "ServerConfig":
        ...
        web_server_enabled = cls._get_bool_from_dict(property_dict=property_dict, key="web_server_enabled")

        cls._assert_all_properties_used(property_dict)
        return ServerConfig(admin_group, database_config, email_config, special_resources,
                            blocking_enabled, preemption_enabled, web_server_enabled)
